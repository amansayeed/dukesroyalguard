<?php
/**
 * Template Name:Marketing Store Page
 *
 */
get_header(); ?>
...
$alt = get_post_meta($thumbnail_id, '_wp_attachment_image_alt', true);
					...
					<div class="item">
						...
						<div class="item-content">
							...
							<div class="infobar">
								<span class="rs">$20 </span>
								<span class="addto_btn"><a href="">Add to Cart</a></span>
								<span  class="learnmore_btn"><a href="EZ-featured-listings.html">Learn More</a></span>
							</div>
						</div>
					</div>
						<?php } ?>	
					<div class="item readall">
						<p><strong>Join Agent 8 to View All The On Demand Products</strong></p>
