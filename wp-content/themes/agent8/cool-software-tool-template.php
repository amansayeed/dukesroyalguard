<?php
/**
 * Template Name:Cool software tool Page
 *
 */
get_header(); ?>
...
$alt = get_post_meta($thumbnail_id, '_wp_attachment_image_alt', true);
					...
					<div class="item">
						...
						<div class="item-content">
							...
							<?php echo do_shortcode("[types field='short-description'][/types]"); ?><a href="<?php echo $post->post_name; ?>" class="more">Read More</a></p>
						</div>
					</div>
					...
					<div class="item readall">
						<p><strong>Join Agent 8 to View All Cool Software Tools</strong></p>
